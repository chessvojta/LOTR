%% Method 1
% People who liked LOTR also liked...
%
% Recommendation is based on the positive reviews of users that read at
% least on of the LOTR books.
...
recommended.Score = bookScore(recommended.Rating,recommended.Reads); %Score based on rating and reads
